...
// Dia 1: R$1 // Dia 2: R$3  // Dia 3: R$6  // ...  // Dia 10: R$55
...
for (let dia = 1; dia <= totalDias1; dia++) {
    economia1 += dia
}

console.log(`Total economizado em ${totalDias1} dias: R$${economia1}`)
...
// ou - exemplo professor

const tempoMinimo1 = 5;
const temperaturaIdealAlcancadaEm1 = 3;
...
do {
    ...
    if (segundos === temperaturaIdealAlcancadaEm1) {
        console.log("Temperatura ideal atingida.");
    }
 
} while (segundos < tempoMinimo1);
